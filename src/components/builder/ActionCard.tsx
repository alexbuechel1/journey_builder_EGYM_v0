              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div className="flex items-center justify-between p-3 rounded-md border border-border bg-muted/30">
                  ...
                  <Switch
                    ...
                    onChange={() => handleToggle('visibleInChecklist')}
                  />
                </div>
                ...
                {action.supportsGuidance && (
                  <div className="flex items-center justify-between p-3 rounded-md border border-border bg-muted/30">
                    ...
                    <Switch
                      ...
                      onChange={() => handleToggle('guidanceEnabled')}
                    />
                  </div>
                )}
                ...
                {/* Time Range Display */}
                <div className="p-3 rounded-md border border-border bg-muted/30">
                  <label className="text-sm font-medium text-foreground block mb-1.5">Time Range</label>
